...
Откроем, проверим, посмотрим.

Отлично, наши машины работают. Продолжим их настройку. Только для того, чтобы применить следующие изменения, сначала уничтожим нашу конфигурацию, снова выполним
